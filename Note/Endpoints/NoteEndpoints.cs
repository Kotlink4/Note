...
namespace Note.Endpoints
{
    public static class NoteEndpoints
    {
        ...
        public static void MapNoteEndpoints(this WebApplication app)
        {
            ...
            noteGroup.MapGet("/", async (INoteServise noteService, CancellationToken cancellationToken) =>
            {
            ...
            noteGroup.MapGet("/{id:guid}", async (Guid id, INoteServise noteService, CancellationToken cancellationToken) =>
            {
            ...
            noteGroup.MapPost("/", async (CreateNoteRequest request, INoteServise noteService, CancellationToken cancellationToken) =>
            {
            ...
            noteGroup.MapPut("/{id:guid}", async (Guid id, UpdateNoteRequest request, INoteServise noteService, CancellationToken cancellationToken) =>
            {
